...
public enum CommandRegistry {
    ...
    FIND_CONFERENCES_BY_NAME(FindConferencByNameCommand.getInstance(),
            "find_conferences_by_name", ADMIN),
    SHOW_FIND_CONFERENCES_BY_NAME(ShowFindConferencByNamePageCommand.getInstance(),
            "show_find_conferences_by_name", ADMIN),
    UPDATE_DESCRIPTION_IN_CONFERENC(UpdateDescriptionInConferencCommand.getInstance(),
            "update_description_in_conferenc", ADMIN),
    FIND_CONFERENCES_BY_ID(FindConferencByIdCommand.getInstance(),
            "find_conferenc_by_id", ADMIN),
    REMOVE_CONFERENCES_BY_ID(RemoveConferencByIdCommand.getInstance(),
            "remove_conferenc_by_id", ADMIN),
    CREATE_CONFERENCES(CreateConferencCommand.getInstance(),
            "create_conferenc", ADMIN),
    SHOW_ALL_CONFERENCES(ShowAllConferencesPageCommand.getInstance(),
            "show_all_conferences", ADMIN),
    SHOW_READ_CONFERENC_BY_ID(ShowReadConferencByIdPageCommand.getInstance(),
    ...
    SHOW_READ_SECTON_CONFERENC_BY_ID(ShowReadSectionConferencByIdPageCommand.getInstance(),
            "show_read_section_conferences_by_id", ADMIN),
    FIND_SECTION_CONFERENCES_BY_ID(FindSectionConferencByIdCommand.getInstance(),
            "find_section_conferenc_by_id", ADMIN),
    CHANGE_STATUS_SECTION_CONFERENC_BY_ID(ChangeStatusSectionConferencCommand.getInstance(),
            "change_status_section_conferenc_by_id", ADMIN),
    REMOVE_SECTION_CONFERENCES_BY_ID(RemoveSectionConferencByIdCommand.getInstance(),
            "remove_section_conferenc_by_id", ADMIN),
    CREATE_SECTION_CONFERENCES(CreateSectionConferencCommand.getInstance(),
            "create_section_conferenc", ADMIN),
    UPDATE_DESCRIPTION_IN_SECTION_CONFERENC(UpdateDescriptionInSectionConferencCommand.getInstance(),
            "update_description_in_section_conferenc", ADMIN),
    FIND_SECTION_CONFERENCES_BY_NAME(FindSectionConferencByNameCommand.getInstance(),
            "find_section_conferences_by_name", ADMIN),
    SHOW_FIND_SECTION_CONFERENCES_BY_NAME(ShowFindSectionConferencByNamePageCommand.getInstance(),
    ...
    CHANGE_NAME_CATEGORY(ChangeNameCategoryCommand.getInstance(),
            "change_name_category", ADMIN),
    SHOW_ALL_CONFERENCES_IN_CATEGORY(ShowFindConferencInIdCategoryPageCommand.getInstance(),
            "show_all_conferences_in_category", UNAUTHORIZED, USER, ADMIN, BLOKED),
    ALL_CONFERENCES_IN_CATEGORY(FindConferencInIdCategoryCommand.getInstance(),
            "all_conferences_in_category", UNAUTHORIZED, USER, ADMIN, BLOKED),
    SHOW_ALL_SECTION_CONFERENCES_IN_CATEGORY(ShowFindSectionConferencInCategoryByIdPageCommand.getInstance(),
            "show_all_section_conferences_in_category", UNAUTHORIZED, USER, ADMIN, BLOKED),
    ALL_SECTION_CONFERENCES_IN_CATEGORY(FindSectionConferencInCategoryByIdCommand.getInstance(),
            "all_section_conferences_in_category", UNAUTHORIZED, USER, ADMIN, BLOKED),
    ID_CATEGORY(FindCategoryByIdCommand.getInstance(),
            "id_category", ADMIN),
    ...
    ADDANSWERTOQUESTION(AddAnswerToQuestionCommand.getInstance(),
            "add_answer_to_question", ADMIN),
    CREATEQUESTION(CreateQuestionCommand.getInstance(),
            "create_question", USER, ADMIN),
    FIND_QUESTIONS_BY_ID_ACCOUNT(FindQuestionByIdAccountCommand.getInstance(),
            "find_questions_by_id_account", USER, ADMIN),
    FIND_QUESTION_BY_ID(FindQuestionByIdCommand.getInstance(),
    ...
    UPDATE_PASSWORD_BY_USER(UpdatePasswordCommand.getInstance(),
            "update_password_by_user", USER, ADMIN),
    UPDATE_EMAIL_BY_USER(UpdateEmailCommand.getInstance(),
            "update_email_by_user", USER, ADMIN),
    UPDATE_FIRST_NAME_BY_USER(UpdateFirstNameCommand.getInstance(),
            "update_first_name_by_user", USER, ADMIN),
    UPDATE_LAST_NAME_BY_USER(UpdateLastNameCommand.getInstance(),
            "update_last_name_by_user", USER, ADMIN),
    UPDATE_ROLE_BY_USER(UpdateRoleCommand.getInstance(),
            "update_role_by_user", ADMIN),
    READ_USER_BY_ID(ReadUserByIdCommand.getInstance(),
            "read_user_by_id", ADMIN),
    SHOW_READ_USER_BY_ID(ShowReadUserByIdPageCommand.getInstance(),
    ...
    SHOW_APPLICATIONS_BY_ACCOUNT(FindAccountIdByApplicationCommand.getInstance(),
            "show_applications_by_account", USER, ADMIN),
    FIND_BY_STATUS_RESULT_APPLICATION(FindByStatusResultApplicationCommand.getInstance(),
            "find_by_status_result_application", ADMIN),
    SHOW_FIND_BY_STATUS_RESULT_APPLICATION(ShowFindByStatusResultApplicationPageCommand.getInstance(),
            "show_find_by_status_result_application", ADMIN),
    REMOVE_APPLICATION(RemoveApplicationByIdCommand.getInstance(),
            "remove_application", USER, ADMIN),
    CREATE_APPLICATION(CreateApplicationCommand.getInstance(),
            "create_application", USER, ADMIN),
    FIND_APPLICATION_BY_ID(FindApplicationByIdCommand.getInstance(),
    ...
    SHOW_ADMIN_PANEL_SECTIONCONFERENC(ShowAdminPanelSectionConferencPageCommand.getInstance(),
            "show_admin_panel_section_conferenc", ADMIN),
    SHOW_ADMIN_PANEL_CATEGORY(ShowAdminPanelCategoryPageCommand.getInstance(),
            "show_admin_panel_category", ADMIN),
    ABOUT(ShowAboutPageCommand.getInstance(),
            "show_about_page"),
    SHOW_PESONAL_ACCOUNT(ShowPersonalAccountPageCommand.getInstance(),
            "show_personal_account", USER, ADMIN),
    CONTACT(ShowContactPageCommand.getInstance(),
            "show_contact"),
    ERROR(ShowErrorPageCommand.getInstance(),
            "show_error"),
    SHOW_LOGIN(ShowLoginPageCommand.getInstance(),
            "show_login", UNAUTHORIZED),
    LOGIN(LoginCommand.getInstance(),
            "login", UNAUTHORIZED),
    SHOW_CREATE_AN_ACCOUNT(ShowCreateAnAccountCommand.getInstance(),
