...
<html>
<head>
    <title>Create section conferenc by id</title>
</head>
<body>
...
<form name="createConferenc-form" action="/controller?command=create_section_conferenc" method="post">
    <label for="name-input">Name SectionConferenc:</label>
    <input id="name-input" type="text" name="name" value=""/>
    <br>
    <label for="description-input">Descriprion SectionConferenc:</label>
